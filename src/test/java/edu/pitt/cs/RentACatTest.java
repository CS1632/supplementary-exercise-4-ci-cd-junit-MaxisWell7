...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		// cannot do: c1 = new Cat(1, "Jennyanydots");
	...
	public void testGetCatNullNumCats0() {
		Cat c = r.getCat(2);
		// if not null, prints the failure message
		assertNull("Returned cat is not null", c);
	}
	...
	public void testGetCatNumCats3() {
		...
		r.addCat(c3);
		Cat c = r.getCat(2);
		assertNotNull("Returned Cat is null", c); // if assertion fails, it prints the failure message
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("Return value is true, not false", b);
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean x = r.catAvailable(2);
		assertTrue("Return value is false", x);
	...
	public void testCatAvailableFalseNumCats3() {
		...
		boolean x = r.catAvailable(2);
		assertFalse("Return value is true, not false", x);
	}
	...
	public void testCatExistsFalseNumCats0() {
		boolean x = r.catExists(2);
		assertFalse("return value is true, cat exists when not supposed to", x);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		r.addCat(c3);
		boolean x = r.catExists(2);
		assertTrue("Return value is not true", x);
	}
	...
	public void testListCatsNumCats0() {
		...
		String x = r.listCats();
		assertEquals("listCats did not return empty", "", x);
	...
	public void testRentCatFailureNumCats0() {
		...
		assertFalse("rentCat returned true instead of false", b);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		boolean x = r.rentCat(2);
		assertFalse("return value is not false", x);
